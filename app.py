    ...
    try:                       
        ...
        if a == 1:
            if msgType == "image":
                ...
                clu_center_st = KMeans(n_clusters = 5, init='k-means++', n_init = 8).fit(colorList)
                ...
                f = 0
                for m in range(5):
                    d = clu_center_nd_0[m][0] + clu_center_nd_0[m][1] + clu_center_nd_0[m][2]
                    if d > c:
                        c = d
                        f = m
                ...
                f = 0
                for m in range(5):
                    d = clu_center_nd_1[m][0] + clu_center_nd_1[m][1] + clu_center_nd_1[m][2]
                    if d > c:
                        c = d
                        f = m
                ...
                f = 0
                for m in range(5):
                    d = clu_center_nd_2[m][0] + clu_center_nd_2[m][1] + clu_center_nd_2[m][2]
                    if d > c:
                        c = d
                        f = m
                ...
                f = 0
                for m in range(5):
                    d = clu_center_nd_3[m][0] + clu_center_nd_3[m][1] + clu_center_nd_3[m][2]
                    if d > c:
                        c = d
                        f = m
                ...
                f = 0
                for m in range(5):
                    d = clu_center_nd_4[m][0] + clu_center_nd_4[m][1] + clu_center_nd_4[m][2]
                    if d > c:
                        c = d
                        f = m
